        ...
        content: [
          {
            ...
            text: `ดึงข้อมูลจากบัตรนักศึกษาใบนี้ ตอบกลับเป็น JSON เท่านั้น ห้ามอธิบายเพิ่มเติม
                    ...
                    ขั้นแรก ดูก่อนว่าภาพเป็นบัตรแบบไหน แล้วใส่ในช่อง cardType
                    - "physical" = ภาพถ่ายบัตรพลาสติกแข็งสี่เหลี่ยม มีแถบสีน้ำเงินด้านบนเขียนว่า
                      "วิทยาลัยเทคนิคสมุทรสาคร" และมีบรรทัด "ชื่อ-สกุล" "เลขประจำตัว"
                      "สาขาวิชา" "ระดับ" พิมพ์อยู่บนบัตร
                    - "online" = ภาพแคปหน้าจอมือถือของ "บัตรประจำตัวออนไลน์" มีรูปถ่ายนักเรียน
                      ชื่อ (ไม่มีคำนำหน้า ไม่มีคำว่า "ชื่อ-สกุล") บาร์โค้ดพร้อมเลข 11 หลักสีน้ำเงิน
                      ใต้บาร์โค้ด คิวอาร์โค้ด และมีแถบเบราว์เซอร์/นาฬิกา/แบตเตอรี่ของมือถือปนอยู่

                    ⚠️ ถ้าเป็นบัตร "online": บัตรแบบนี้ "ไม่มี" คำนำหน้า สาขาวิชา และระดับ
                    อยู่บนภาพเลย — ต้องตอบ rawMajorLine เป็น "" และ level เป็น "" เสมอ ห้ามเดา
                    หรือเติมเองจากความรู้ทั่วไปเด็ดขาด, studentId คือเลข 11 หลักใต้บาร์โค้ด,
                    rawNameLine คือชื่อ-นามสกุลใต้รูปถ่ายเท่านั้น (ห้ามเอาข้อความบนแถบเบราว์เซอร์
                    เช่น ที่อยู่เว็บ เวลา หรือตัวเลขอื่นมาใส่)
                    ...
                    { "cardType": "physical หรือ online", "studentId": "...", "rawNameLine": "...", "rawMajorLine": "...", "level": "..." }

                    หลักสำคัญ: ตอบเฉพาะสิ่งที่ "เห็นในภาพจริง" เท่านั้น ช่องไหนไม่มีในภาพให้ตอบ ""`,
          },
